const es = {
  ...
  search: {
    open: "Buscar",
    title: "Búsqueda",
    placeholder: "Buscar por tecnología, proyecto, empresa...",
...
`,
  ...
  accessibility: {
    ...
    fontSizeLabel: "Tamaño de la fuente",
    fontSizes: {
      small: "Pequeña",
      normal: "Estándar",
      large: "Grande",
    ...
    textSpacing: "Aumentar espaciado",
    underlineLinks: "Subrayar enlaces",
    colorFilterLabel: "Asistencia de color",
    colorFilterHint:
      "Filtros que ayudan a personas con distintos tipos de daltonismo.",
    colorFilters: {
      none: "Ninguno",
